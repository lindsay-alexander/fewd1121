...
// Requirements: Create a separate function, called appendItem, that accepts one argument, item, that is called
// when #clickme is clicked and appends the <li> to #list
